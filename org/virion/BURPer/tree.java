...
public class tree{
	...
	public tree(String treefile, ArrayList<String> taxaNames, ArrayList<String> taxaStates, String [] availableStates){
//-		System.out.println("tips: " + taxaNames.size());
		this.availableStates = availableStates;
		topnode = new node(taxaNames, taxaStates, treefile, 1, availableStates);
