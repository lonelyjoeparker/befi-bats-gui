...
public class LabelledTree{
	...
	public LabelledTree(String treefile, ArrayList<String> taxaNames, ArrayList<String> taxaStates, String [] availableStates){
//-		System.out.println("tips: " + taxaNames.size());
		this.availableStates = availableStates;
		try{
			System.out.println("\tConstructing first-pass in");
			topnode = new LabelledNode(taxaNames, taxaStates, treefile, 1, availableStates);
			//-		topnode.printStateWeights();
			System.out.println("\tutility stuff...");
			topnode.setTop();
			System.out.println("\tnaming internal nodes...");
			topnode.setNameInternalNodes();
	/*
	 * 		NOTE - 04/JULY/2008
	 * 
