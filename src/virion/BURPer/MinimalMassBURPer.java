...
public class MinimalMassBURPer{
...
//	private ArrayList<String> taxaNames = new ArrayList<String>();
	...
	public MinimalMassBURPer(int reps){
		this.reps = reps;
	}

	public MinimalMassBURPer(int reps, String filename){
		this.reps = reps;
...
//
	public double[][] singleAnalyse(int maxStates){
		...
		for(String aTree:treefile){
			...
			obsVals [5][count] = t.getNodalNTI();
			obsVals [6][count] = t.getNodalNRI();
			obsVals [7][count] = (float)t.getUniFrac();
			for(int i = 0; i<numStates; i++){
...
//-				System.out.println("\ttree "+ count);
				tree t = new tree(aTree, taxaNames, tempRearrangement, availableStates);
...
//-				System.out.println(possible + " added");
	 ...
	 */
	public void setLastTree(tree lastTree) {
